...
namespace Dravencms\HtmlSnippet\DI;
 ...
 */
class HtmlSnippetExtension extends Nette\DI\CompilerExtension
{
    ...
    public function loadConfiguration()
    {
        ...
        $builder->addDefinition($this->prefix('htmlSnippet'))
            ->setClass('Dravencms\HtmlSnippet\HtmlSnippet', []);
     ...
     */
    public static function register(Configurator $config, $extensionName = 'htmlSnippetExtension')
    {
        $config->onCompile[] = function (Configurator $config, Compiler $compiler) use ($extensionName) {
            $compiler->addExtension($extensionName, new HtmlSnippetExtension());
        };
    }
