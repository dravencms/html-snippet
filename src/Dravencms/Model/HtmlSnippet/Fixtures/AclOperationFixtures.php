...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $operations = [
            'htmlSnippet' => [
                'edit' => 'Umožnuje editaci HtmlSnippet',
                'delete' => 'Umožnuje smazání HtmlSnippet'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\HtmlSnippet\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}